...
describe('Version Compatibility (v7.0.0)', () => {
  ...
  it('older minor (within MIN_SUPPORTED) is compatible with warning', () => {
    ...
    // path that the patch-difference test no longer covers after the v8.5.1
    // bump (current contract is 8.5.2; 8.1.1 is older minor + patch).
