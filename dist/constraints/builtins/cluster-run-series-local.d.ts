 ...
 * @since v8.7.0 — FR-G1 (PR-A4.1).
 */
export declare function arrayFieldDistinct(array: unknown, fieldName: string): {
    valid: boolean;
    duplicates: Array<{
        value: string;
        indices: number[];
 ...
 * @since v8.7.0 — FR-G1 (PR-A4.1).
 */
export declare function failureModeIffFailedStatus(epicStatus: unknown, failureMode: unknown): {
    valid: boolean;
    reason?: string;
};
//# sourceMappingURL=cluster-run-series-local.d.ts.map