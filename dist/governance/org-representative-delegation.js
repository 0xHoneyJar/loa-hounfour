 ...
 */
export const ORG_DELEGATION_GENESIS_SENTINEL = 'genesis:org-public-key';
export const OrgRepresentativeDelegationSchema = Type.Object({
    ...
    capability_scope: Type.Record(Type.String(), Type.Unknown(), {
        description: 'Domain-specific capability scope. Keys are consumer-defined. '
    ...
    revocation: Type.Optional(Type.Object({
        revoked: Type.Literal(true, {
            description: 'Pinned to literal `true`. The presence of the revocation envelope is the '
        ...
        revoked_by: Type.String({
            ...
            description: 'Pattern matches `AgentIdentity.agent_id` (`^[a-z][a-z0-9_-]{2,63}$`) — '
        ...
        description: 'Revocation envelope. When present, this record revokes the delegation. The '
    ...
    granted_by: Type.Union([
        ...
        description: 'Either the prior delegation_id (UUID v4) in the chain, or the literal genesis '
    ...
    chain_depth: Type.Integer({
        minimum: 0,
        maximum: 20,
        description: 'Asserted depth of this delegation in the chain (0 for genesis-granted). '
