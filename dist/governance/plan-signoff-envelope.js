...
export const SignoffActorClassSchema = Type.Union([
    ...
    description: 'Exhaustive 3-member enum for the actor class authorizing a ' +
 ...
 */
export const SignoffTierSchema = Type.Union([Type.Literal('T2'), Type.Literal('T3')], {
    $id: 'SignoffTier',
    description: 'Schema-restricted signoff tier. T0/T1 are explicitly excluded ' +
...
export const PlanSignoffEnvelopeSchema = Type.Object({
    envelope_kind: Type.Literal('plan_signoff', {
        description: 'Discriminator literal pinning the plan-signoff shape. ' +
    ...
    ts: Type.String({
        ...
        description: 'ISO 8601 UTC timestamp at signoff emission (Z suffix). ' +
    ...
    cluster_id: Type.String({
        minLength: 1,
        description: 'Stable cluster identifier (consumer-shaped — hounfour does ' +
    ...
    plan_content_hash: Type.String({
        ...
        description: 'sha256:<64-hex> content hash of the plan being signed off. ' +
    ...
    signoff_actor_id: Type.String({
        minLength: 1,
        description: 'Stable identifier for the signing actor (consumer-shaped). ' +
    ...
    reason: Type.String({
        minLength: 1,
        maxLength: 8192,
        description: 'Free-text rationale for the signoff. Capped at 8 KB code ' +
    ...
    chain_refs: Type.Object({
        ...
        parent_signoff_hash: Type.Union([Type.String({ pattern: SHA256_HEX_PATTERN }), Type.Null()], {
            description: 'sha256:<64-hex> hash of the parent signoff envelope, ' +
        ...
        description: 'Chain references: envelope-level continuity ' +
            '(prev_envelope_hash) plus signoff-lineage continuity ' +
            '(parent_signoff_hash, nullable).',
    }),
    cumulative_drift_pct: Type.Number({
        minimum: 0,
        description: 'Cumulative plan-execution drift as a non-negative percent. ' +
    ...
    description: 'Plan-signoff envelope binding a plan (plan_content_hash) to a ' +
...
//# sourceMappingURL=plan-signoff-envelope.js.map