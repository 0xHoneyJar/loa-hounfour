...
// ---------------------------------------------------------------------------
export const REPUTATION_TRANSITIONS = {
    warm: {
        from: 'cold',
        to: 'warming',
 ...
 */
export function isValidReputationTransition(from, to) {
 ...
 */
export function computePersonalWeight(sampleCount, pseudoCount) {
 ...
 */
export function computeBlendedScore(personalScore, collectionScore, sampleCount, pseudoCount) {
