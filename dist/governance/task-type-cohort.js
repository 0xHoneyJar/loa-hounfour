...
export const TaskTypeCohortSchema = Type.Object({
    ...
    confidence_threshold: Type.Optional(Type.Integer({
        minimum: 1,
        default: 30,
        description: 'Sample count at which task-specific scores are trusted at full weight. ' +
 ...
 */
export function validateTaskCohortUniqueness(cohorts) {
    const seen = new Set();
    const duplicates = [];
...
//# sourceMappingURL=task-type-cohort.js.map