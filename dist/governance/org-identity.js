...
export const OrgIdentitySchema = Type.Object({
    ...
    current_representatives: Type.Array(AgentIdentitySchema, {
        minItems: 1,
        description: 'Snapshot of currently-active representative AgentIdentity records. '
    ...
    description: 'Org root identity: org_id + cold-storage public key + active representatives + '
        + 'constitutional hash. Cross-field rule OI-1 in constraints/OrgIdentity.constraints.json.',
});
//# sourceMappingURL=org-identity.js.map