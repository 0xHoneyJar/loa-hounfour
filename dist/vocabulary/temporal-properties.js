...
export const TEMPORAL_PROPERTIES = [
    ...
    },
    {
        ...
        type: 'liveness',
        scope: 'stake',
        description: 'For any active stake, there exists a valid path to a terminal state (slashed or withdrawn).',
        formal: 'eventually(state ∈ {slashed, withdrawn})',
        testable: true,
        test_strategy: 'BFS reachability from every non-terminal stake state to at least one terminal state',
    },
];
//# sourceMappingURL=temporal-properties.js.map