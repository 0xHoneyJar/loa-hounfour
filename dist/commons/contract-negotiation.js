 ...
 */
export const AssertionMethodSchema = Type.Union([Type.Literal('server-derived'), Type.Literal('signed-attestation')], {
    description: 'How the reputation_state was determined. '
...
export const ContractNegotiationSchema = Type.Object({
    ...
    description: 'Runtime handshake for dynamic contract negotiation. '
        + 'Model presents reputation state, receives allowed protocol surface. '
        + 'Reputation MUST be server-derived or signed — self-assertion is non-conformant.',
});
//# sourceMappingURL=contract-negotiation.js.map