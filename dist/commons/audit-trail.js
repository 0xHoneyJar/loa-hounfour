 ...
 */
export const AUDIT_TRAIL_GENESIS_HASH = 'sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855';
/**
...
export const AuditEntrySchema = Type.Object({
    ...
    event_type: Type.String({
        ...
        description: 'Dotted event type (e.g., commons.transition.executed). '
    ...
    hash_domain_tag: Type.String({
        minLength: 1,
        description: 'The exact domain tag used when computing entry_hash. '
...
export const AuditTrailSchema = Type.Object({
    ...
    integrity_status: Type.Union([
        ...
        description: 'verified: chain integrity confirmed. '
            + 'unverified: chain not yet checked. '
            + 'quarantined: discontinuity detected, entries after break are suspect.',
    }),
    checkpoint_hash: Type.Optional(Type.String({
        pattern: '^sha256:[a-f0-9]{64}$',
        description: 'Hash of the most recent checkpoint. When present, entries before '
    ...
    checkpoint_index: Type.Optional(Type.Integer({
        minimum: 0,
        description: 'Index of the last checkpointed entry. Entries at or before this '
