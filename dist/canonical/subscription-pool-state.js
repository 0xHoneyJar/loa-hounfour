 ...
 * @since v8.7.0 — FR-G3.
 */
// Stub — full schema body lands in PR-A4.3.
 ...
 */
export const SubscriptionPoolStateSchema = Type.Never({
    $id: '@0xhoneyjar/loa-hounfour/8.7.0/subscription-pool-state.json',
    description: 'STUB — PR-A4.0 reservation. Full schema body lands in PR-A4.3.',
});
