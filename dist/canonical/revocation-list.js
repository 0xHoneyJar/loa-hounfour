 ...
 * @since v8.7.0 — FR-G4.
 */
// Stub — full schema body lands in PR-A4.4.
 ...
 */
export const RevocationListSchema = Type.Never({
    $id: '@0xhoneyjar/loa-hounfour/8.7.0/revocation-list.json',
    description: 'STUB — PR-A4.0 reservation. Full schema body lands in PR-A4.4.',
});
