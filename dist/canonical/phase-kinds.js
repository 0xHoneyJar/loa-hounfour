...
export const PhaseKindSchema = Type.Union(PHASE_KINDS.map((m) => Type.Literal(m)), {
    $id: 'PhaseKind',
    description: 'Exhaustive 5-member enum classifying a phase within a ' +
        "CanonicalRun's required_phases sequence. Widening is " +
        'strict-additive across minor versions.',
});
//# sourceMappingURL=phase-kinds.js.map