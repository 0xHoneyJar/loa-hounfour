...
export { createTransitionValidator, DEFAULT_GUARDS, guardKey, isValidGuardResult, requiresTransferId, requiresNoActiveTransfer, requiresReasonResolved, requiresTransferCompleted, type TransitionValidator, type TransitionGuard, type GuardResult, } from './utilities/lifecycle.js';
...
export { METADATA_NAMESPACES, MODEL_METADATA_KEYS, type MetadataNamespace, type ModelMetadataKey, } from './vocabulary/metadata.js';
