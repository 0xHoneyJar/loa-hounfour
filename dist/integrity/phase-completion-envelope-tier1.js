...
export const PhaseCompletionEnvelopeTier1Schema = Type.Object({
    envelope_kind: Type.Literal('phase_completion_tier1', {
        description: 'Discriminator literal pinning the Tier-1 shape. The Tier-2 ' +
            'wrapper uses the literal "phase_completion".',
    }),
    contract_version: Type.Literal('8.6.0', {
        description: 'Hounfour contract version this envelope was authored against. ' +
            'Pinned to "8.6.0" for the cycle-005 ship line.',
    }),
    agent_id: Type.String({
        minLength: 1,
        description: 'Stable agent identifier (consumer-shaped — hounfour does not ' +
    ...
    agent_key_pubkey: Type.String({
        ...
        description: 'Ed25519 public key identifier of the signer (32-byte key → ' +
            '43 unpadded base64url chars per RFC 4648 §5).',
    }),
    payload: Type.Record(Type.String(), Type.Unknown(), {
        description: 'Consumer-shaped payload (phase outcomes, gate decisions, ' +
            'attestations). Hounfour does NOT freeze the sub-shape per ' +
            'ADR-010 — class-vs-policy boundary.',
    }),
    nonce: Type.String({
        pattern: BASE64URL_NONCE_PATTERN,
        description: '128-bit nonce as 22-char unpadded base64url. Used by the FR-C1 ' +
    ...
    timestamp: Type.String({
        ...
        description: 'ISO 8601 UTC timestamp at agent emission (Z suffix; non-UTC ' +
    ...
    description: 'Agent-emission Tier-1 phase-completion envelope. Wrapped by ' +
...
//# sourceMappingURL=phase-completion-envelope-tier1.js.map