 ...
 */
export declare const SHA256_HEX_PATTERN = "^sha256:[A-Fa-f0-9]{64}$";
/**
 ...
 * @since v8.6.0 — FR-B2 (PR-A3.4)
 */
export declare const SHA256_HEX_BARE_PATTERN = "^[A-Fa-f0-9]{64}$";
//# sourceMappingURL=sha256-pattern.d.ts.map