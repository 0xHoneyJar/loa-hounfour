...
export const EconomicPerformanceEventSchema = Type.Object(
  ...
  },
  {
    ...
    additionalProperties: false,
    description:
      'Captures the outcome of a model invocation following an EconomicBoundary access decision. ' +
...
export const PerformanceQualityBridgeSchema = Type.Object(
  ...
  },
  {
    ...
    additionalProperties: false,
    description:
      'Connects economic performance outcomes to reputation quality events. ' +
