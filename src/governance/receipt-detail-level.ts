...
export const ReceiptDetailLevelSchema = Type.Union(
  ...
  ],
  {
    ...
    description:
      'Verbosity selector for RecallReceipt. Three substrate-agnostic levels: minimal | standard | debug. The consumer\'s audit policy decides what fields populate each level; the library ships only the selector vocabulary.',
  },
);
