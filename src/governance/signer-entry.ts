...
export const SignerEntrySchema = Type.Object(
  {
    signer_id: Type.String({
      ...
      description:
        'Stable opaque identifier for the signer within its keyring. Lowercase, hyphens / underscores; 3-64 chars.',
    }),
    key_ref: Type.String({
      minLength: 1,
      description:
  ...
  },
  {
    ...
    description:
      'Cryptographic-material entry inside a Keyring. Binds signer_id + key_ref to a public key, signature kind, scoped trust profile, and lifecycle status.',
  },
);
