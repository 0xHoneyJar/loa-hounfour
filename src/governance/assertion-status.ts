...
export const AssertionStatusSchema = Type.Union(
  ...
  ],
  {
    $id: 'AssertionStatus',
    description:
      'Lifecycle vocabulary for Assertion. Eight states: candidate (pre-admission, non-crypto-bearing) + admitted | superseded | challenged | revoked | forgotten | escrow | archived (post-admission, crypto-bearing).',
  },
);
