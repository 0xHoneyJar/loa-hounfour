 ...
 */
export const AmendmentSeveritySchema = Type.Union(
  [Type.Literal('minor'), Type.Literal('major')],
  {
    $id: 'AmendmentSeverity',
    description:
      'Two-member exhaustive severity enum for plan amendments. ' +
...
export const AmendmentTriggerClassSchema = Type.Union(
  ...
  ],
  {
    ...
    description:
      'Four-member exhaustive enum for what triggered the amendment. ' +
...
export const PlanAmendmentRequestSchema = Type.Object(
  {
    envelope_kind: Type.Literal('plan_amendment_request', {
      description:
        'Discriminator literal pinning the plan-amendment-request ' +
    ...
    ts: Type.String({
      ...
      description:
        'ISO 8601 UTC timestamp at amendment-request emission.',
    }),
    cluster_id: Type.String({
      minLength: 1,
      description:
        'Stable cluster identifier (consumer-shaped). Identifies ' +
        'the cluster the amendment is scoped to.',
    }),
    actor_id: Type.String({
      minLength: 1,
      description:
        'Stable identifier for the actor proposing the amendment ' +
        '(consumer-shaped).',
    }),
    parent_signoff_id: Type.String({
      minLength: 1,
      description:
        'Identifier of the signoff this amendment is proposed ' +
    ...
    parent_plan_hash: Type.String({
      ...
      description:
        'sha256:<64-hex> content hash of the plan being amended. ' +
    ...
    proposed_delta: Type.String({
      ...
      maxLength: 65536,
      description:
        'Free-text amendment proposal. Capped at 64 KB code ' +
    ...
    rationale: Type.String({
      ...
      maxLength: 8192,
      description:
        'Free-text rationale explaining why the amendment is ' +
        'needed. Capped at 8 KB code points.',
    }),
    recommended_paths: Type.Array(
      Type.Object(
        {
          id: Type.String({
            minLength: 1,
          ...
          tradeoff: Type.String({
            minLength: 1,
            description:
              'Explicit tradeoff statement — what this path costs ' +
        ...
        },
        {
          ...
          description:
            'A single recommended-path object. All three fields ' +
      ...
      ),
      {
        minItems: 1,
        description:
          'Non-empty array of recommended paths. An amendment MUST ' +
          'propose at least one concrete path; "do nothing" should ' +
          'be expressed explicitly as a path entry, not as an ' +
          'empty array.',
      },
    ),
    jury_recommendation: Type.Union(
      [Type.String(), Type.Null()],
      {
        description:
          'Jury recommendation text, or null if no jury was ' +
    ...
    chain_refs: Type.Object(
      ...
      },
      {
        additionalProperties: false,
        description:
          'Chain reference for envelope-level continuity. Unlike ' +
  ...
  },
  {
    ...
    description:
      'Plan-amendment proposal envelope. Chain-bearing (carries ' +
