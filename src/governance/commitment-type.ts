...
export const CommitmentTypeSchema = Type.Union(
  ...
  ],
  {
    $id: 'CommitmentType',
    description:
      'Discriminator vocabulary for CommitmentRoot. Four substrate-agnostic categories: estate_checkpoint | recall_receipt | transition_bundle | revocation_checkpoint.',
  },
);
