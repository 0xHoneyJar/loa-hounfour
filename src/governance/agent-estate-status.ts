...
export const AgentEstateStatusSchema = Type.Union(
  ...
  ],
  {
    ...
    description:
      'Lifecycle vocabulary for AgentEstate. Five substrate-agnostic states: provisioning | active | paused | transferring | dissolved. State-machine validity is consumer-side per ADR-010.',
  },
);
