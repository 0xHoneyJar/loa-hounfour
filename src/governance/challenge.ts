...
export const ChallengeSchema = Type.Object(
  {
    envelope_kind: Type.Literal('challenge', {
      description:
        'Discriminator literal pinning the challenge shape. ' +
    ...
    challenge_id: Type.String({
      minLength: 1,
      description:
        'Stable opaque identifier for this challenge (consumer- ' +
    ...
    ts: Type.String({
      ...
      description:
        'ISO 8601 UTC timestamp at challenge emission (Z suffix). ' +
    ...
    challenger_id: Type.String({
      minLength: 1,
      description:
        'Stable identifier for the challenging actor (consumer- ' +
    ...
    target_assertion_id: Type.String({
      minLength: 1,
      description:
        'String reference to the Assertion being challenged. ' +
    ...
    rationale: Type.String({
      ...
      maxLength: 8192,
      description:
        'Narrative rationale for the challenge. minLength: 1 ' +
    ...
    evidence_hashes: Type.Array(
      Type.String({
        ...
        description:
          'sha256:<64-hex> content hash of a supporting evidence ' +
      ...
      {
        description:
          'Array of supporting evidence hashes. Empty array is ' +
  ...
  },
  {
    ...
    description:
      'Formal challenge envelope against an Assertion (FR-A1). ' +
