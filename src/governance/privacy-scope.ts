...
export const PrivacyScopeSchema = Type.Union(
  ...
  ],
  {
    $id: 'PrivacyScope',
    description:
      'Privacy classification for Assertion payloads. Four substrate-agnostic levels: public | participants_only | controller_only | compliance_only. Vocabulary only — enforcement is consumer-side.',
  },
);
