...
export const ModelCallCircuitBreakerStateSchema = Type.Union(
  [Type.Literal('healthy'), Type.Literal('degraded'), Type.Literal('open')],
  {
    $id: 'ModelCallCircuitBreakerState',
    description:
      'Three-state circuit-breaker enum for the cluster\'s model-call ' +
...
export const OracleHealthEnvelopeSchema = Type.Object(
  ...
  },
  {
    ...
    additionalProperties: false,
    description:
      'Operational health snapshot of an oracle cluster. Heartbeat ' +
