...
export const HashChainDiscontinuitySchema = Type.Object(
  {
    ...
    failure_phase: Type.Union(
      [Type.Literal('content'), Type.Literal('chain')],
      { description: 'Which verification phase detected the failure.' },
    ),
  },
  {
    ...
    description:
      'Event recording a detected hash chain discontinuity in an audit trail. '
