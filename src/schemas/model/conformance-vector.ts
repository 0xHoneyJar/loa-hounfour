...
export const MatchingRulesSchema = Type.Object(
  {
    ...
    null_handling: Type.Optional(
      Type.Union([Type.Literal('strict'), Type.Literal('equivalent')]),
    ),
  },
...
export const ConformanceVectorSchema = Type.Object(
  {
    ...
    cross_field_validations: Type.Optional(
      Type.Array(CrossFieldExpectationSchema),
    ),
  ...
  },
  {
    ...
    description:
      'Cross-language conformance test vector for adapter verification.',
    additionalProperties: false,
  },
);
