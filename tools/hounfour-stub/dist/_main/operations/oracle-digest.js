...
export const PulseKindSchema = Type.Union([Type.Literal('morning'), Type.Literal('afternoon'), Type.Literal('evening')], {
    $id: 'PulseKind',
    description: 'Three-pulse-per-day cadence enum for OracleDigest. Each cluster ' +
...
export const OracleDigestSchema = Type.Object({
    ...
    epic_summary_24h: Type.Array(Type.Object({
    ...
    telegram_variant_md_below_4kb: Type.String({
        maxLength: 4096,
        description: 'Markdown body shipped to Telegram, capped at 4096 UTF-8 bytes. ' +
    ...
    description: 'Pulse-time cluster conformance digest. Three pulses per day per ' +
...
//# sourceMappingURL=oracle-digest.js.map