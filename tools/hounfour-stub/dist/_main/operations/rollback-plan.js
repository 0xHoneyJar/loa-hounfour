...
export const RollbackPlanSchema = Type.Object({
    ...
    prs_to_revert: Type.Array(Type.Object({
        repo: Type.String({ minLength: 1 }),
        pr_number: Type.Integer({ minimum: 1 }),
        merge_commit_sha: Type.String({
            pattern: '^[A-Fa-f0-9]{40}$',
            description: '40-hex git commit SHA (SHA-1; distinct from the 64-hex sha256 used elsewhere).',
        }),
    }, { additionalProperties: false })),
    beads_to_reopen: Type.Array(Type.Object({
        bead_id: Type.String({
            minLength: 1,
            description: 'Generic identifier referencing a consumer-side task tracker. ' +
    ...
    env_changes_to_undo: Type.Array(Type.Object({
        key: Type.String({ minLength: 1 }),
        previous_value: Type.Union([Type.String(), Type.Null()], {
            description: 'Nullable string. null = the env var was unset before the change ' +
    ...
    $id: 'RollbackPlan',
    additionalProperties: false,
    description: 'Declarative rollback recipe for an EPIC. Empty arrays are valid ' +
...
//# sourceMappingURL=rollback-plan.js.map