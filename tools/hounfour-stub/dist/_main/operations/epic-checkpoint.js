...
export const EpicCheckpointSchema = Type.Object({
    ...
    in_progress_tool_call: Type.Object({
        ...
        input_hash: Type.String({
            ...
            description: '64-hex sha256 of the tool-call inputs canonical form, used ' +
    ...
    $id: 'EpicCheckpoint',
    additionalProperties: false,
    description: 'Durable EPIC progress checkpoint. canonical_run_id resolves ' +
...
//# sourceMappingURL=epic-checkpoint.js.map