 ...
 * @since v8.7.0 — FR-G4 (PR-A4.4).
 */
export function fieldNotInArrayField(scalarValue, array, fieldName) {
    if (typeof scalarValue !== 'string' || !Array.isArray(array)) {
        return { valid: true };
    }
    for (let i = 0; i < array.length; i += 1) {
        ...
        if (value === scalarValue) {
            return { valid: false, matchedIndex: i };
        }
    }
    return { valid: true };
}
 ...
 * @since v8.7.0 — FR-G4 (PR-A4.4).
 */
export function fieldInArrayField(scalarValue, array, fieldName) {
    if (typeof scalarValue !== 'string' || !Array.isArray(array)) {
        return { valid: false };
    }
    for (let i = 0; i < array.length; i += 1) {
...
//# sourceMappingURL=revocation-list-local.js.map