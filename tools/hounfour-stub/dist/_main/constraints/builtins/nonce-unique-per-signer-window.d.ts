 ...
 */
export type NonceBuiltinErrorCode = 'NONCE_REPLAY_DETECTED' | 'NONCE_CONTEXT_DEFERRED' | 'NONCE_INVALID_INPUT';
 ...
 */
export declare function evaluateNonceUniquePerSignerWindow(record: unknown, signerIdField: string, nonceField: string, state: NonceWindowState | undefined): EvaluateNonceUniquePerSignerWindowResult;
//# sourceMappingURL=nonce-unique-per-signer-window.d.ts.map