...
export const ESCROW_TRANSITIONS = Object.fromEntries(STATE_MACHINES.escrow.states.map(s => [s, getValidTransitions('escrow', s)]));
export function isValidEscrowTransition(from, to) {
    return _isValidTransition('escrow', from, to);
}
//# sourceMappingURL=escrow-entry.js.map