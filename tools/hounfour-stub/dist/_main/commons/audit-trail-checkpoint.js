import { verifyAuditTrailIntegrity } from './audit-trail-hash.js';
/**
 ...
 */
export function createCheckpoint(trail, index) {
 ...
 */
export function verifyCheckpointContinuity(trail) {
 ...
 */
export function pruneBeforeCheckpoint(trail) {
    if (trail.checkpoint_hash === undefined || trail.checkpoint_index === undefined) {
...
//# sourceMappingURL=audit-trail-checkpoint.js.map