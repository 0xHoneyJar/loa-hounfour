...
export const StateSchema = Type.Object({
    ...
    entry_conditions: Type.Optional(Type.Array(Type.String({
        description: 'Constraint DSL expressions evaluated on entering this state.',
    }))),
    exit_conditions: Type.Optional(Type.Array(Type.String({
...
export const StateMachineConfigSchema = Type.Object({
    ...
    additionalProperties: false,
    description: 'State machine configuration for a governed resource. '
