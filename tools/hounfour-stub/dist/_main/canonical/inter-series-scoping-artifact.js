 ...
 * @since v8.7.0 — FR-G2.
 */
// Stub — full schema body lands in PR-A4.2.
 ...
 */
export const InterSeriesScopingArtifactSchema = Type.Never({
    $id: '@0xhoneyjar/loa-hounfour/8.7.0/inter-series-scoping-artifact.json',
    description: 'STUB — PR-A4.0 reservation. Full schema body lands in PR-A4.2.',
});
