...
export const MergeArtifactSchema = Type.Object({
    ...
    pr_number: Type.Integer({
        ...
        description: 'Positive integer pull-request identifier. Upper bound is ' +
    ...
    merged_commit_sha: Type.String({
        ...
        description: 'Git SHA-1 commit hash — 40 lowercase hex chars. MA-1 ' +
    ...
    master_content_hash: Type.String({
        ...
        description: 'SHA-256 of the JCS-canonical-form (RFC 8785, per SDD §2.0.1) ' +
    ...
    merged_at: Type.String({
        ...
        description: 'ISO 8601 UTC timestamp at which the merge landed. MA-3 ' +
            'library-evaluable pattern.',
    }),
    merger_actor_id: Type.String({
        minLength: 1,
        maxLength: 256,
        description: 'Consumer-shaped actor identifier — typically a GitHub user ' +
    ...
    description: 'Cluster-level merge event. NOT crypto-bearing, NOT chain-' +
 ...
 * @since v8.7.0 — FR-G5 (PR-A4.5).
 */
export function validateMergeArtifact(data) {
...
//# sourceMappingURL=merge-artifact.js.map