...
const SuccessionActionRuleSchema = Type.Object({
    threshold: Type.Number({
        minimum: 0,
        maximum: 1,
        description: 'Quorum fraction in [0, 1] required to enact this action. Compared across '
            + 'actions by the SP-1 asymmetric-ladder rule.',
    }),
    cooldown_seconds: Type.Integer({
        minimum: 0,
        description: 'Minimum elapsed seconds between successive actions of this kind. Compared '
...
export const SuccessionPolicySchema = Type.Object({
    ...
    description: 'Constitutional thresholds enforcing the asymmetric ladder + non-decreasing '
        + 'cooldown invariants. Cross-field rules SP-1..2 in '
        + 'constraints/SuccessionPolicy.constraints.json.',
});
//# sourceMappingURL=succession-policy.js.map