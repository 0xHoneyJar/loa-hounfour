export const SANCTION_SEVERITY_LEVELS = ['warning', 'rate_limited', 'pool_restricted', 'suspended', 'terminated'];
export const SANCTION_SEVERITY_ORDER = {
    warning: 1,
    rate_limited: 2,
    pool_restricted: 3,
    suspended: 4,
...
export const VIOLATION_TYPES = ['content_policy', 'rate_abuse', 'billing_fraud', 'identity_spoofing', 'resource_exhaustion', 'community_guideline', 'safety_violation'];
