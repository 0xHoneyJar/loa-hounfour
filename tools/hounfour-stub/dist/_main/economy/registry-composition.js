 ...
 */
export function withAnnotation(schema, annotations) {
...
// Registry Bridge
// ---------------------------------------------------------------------------
export const RegistryBridgeSchema = withAnnotation(Type.Object({
    ...
    transfer_protocol: Type.Optional(Type.Union([Type.Literal('atomic'), Type.Literal('choreography')], {
...
// ---------------------------------------------------------------------------
export const CANONICAL_BRIDGE_INVARIANTS = [
    {
        invariant_id: 'B-1',
...
//# sourceMappingURL=registry-composition.js.map