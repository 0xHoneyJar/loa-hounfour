...
export const BridgeTransferSagaSchema = Type.Object({
    ...
    saga_type: Type.Union([Type.Literal('atomic'), Type.Literal('choreography')], { description: 'Whether the saga uses atomic or choreography coordination.' }),
...
//# sourceMappingURL=bridge-transfer-saga.js.map